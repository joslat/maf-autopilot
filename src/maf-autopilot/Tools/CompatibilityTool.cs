    ...
    internal static readonly IReadOnlyDictionary<string, string> Matrix =
        new SortedDictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["1.13.0"] = """
                ...
                | Microsoft.Extensions.AI                   | `≥ 10.6.0` | Carried from 1.12.0 |
                ...
                **Breaking** — review required. See `guides/maf-1.13.0-migration-guide.md` and the registry entries. Transitive pins carried from 1.12.0 (verify).
                """,

    ...
    internal static readonly IReadOnlyDictionary<string, string> Matrix =
        new SortedDictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ["1.15.0"] = """
                ...
                **Breaking** — review required. API summary: 10 breaking. See `guides/maf-1.15.0-migration-guide.md` and the registry entries. Transitive pins carried from 1.14.0 (verify).
                """,

...
public static class AgentScaffolder
{
    ...
    private static string AgentTemplate(string className, string ns, string instructions)
    {
        ...
        return $$"""
            // <auto-generated by maf-autopilot — best-practice defaults: OpenTelemetry wired, MaxTokens set, ManagedIdentityCredential preferred>
            ...
            /// <summary>
            /// {{className}} — a MAF 1.3.0 chat-client agent.
            /// Generated by maf-autopilot. Tweak the Instructions string + ChatOptions
    ...
    private static string AgentTestTemplate(string className, string ns) => $$"""
        // <auto-generated by maf-autopilot — smoke test stub for {{className}}>
        using System;
    ...
    private static string ExecutorTemplate(string className, string ns, string inputType, string outputType) => $$"""
        // <auto-generated by maf-autopilot — fan-out-safe executor with Task<{{outputType}}> return>
        using System.Threading;
        using System.Threading.Tasks;
        using Microsoft.Agents.AI;
        ...
        /// <summary>
        /// {{className}} — a MAF 1.3.0 workflow executor. The [MessageHandler]
        ...
        ///
        /// Generated by maf-autopilot. The fan-out validator pre-clears this shape.
        /// </summary>
    ...
    private static string ExecutorTestTemplate(string className, string ns, string inputType, string outputType) => $$"""
        // <auto-generated by maf-autopilot — fan-out shape verification for {{className}}>
        using System;
        using System.Linq;

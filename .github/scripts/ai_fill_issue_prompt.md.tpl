...
4. *(Optional)* **`src/maf-autopilot/Tools/CompatibilityTool.cs`** — this
   file has a parallel hardcoded `Matrix` dictionary. If updating the
   markdown matrix, mirror the change here too to prevent drift.

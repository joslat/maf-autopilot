...
<!-- auto-updated-by: maf-release-watcher | last-updated: 2026-08-06 -->
...
|-------------|------------------------|------|-----------------|--------------------|-------|
| **1.17.0** | `≥ 10.6.0` | `≥ 8.0` | _(not pinned by MAF — BYO via IChatClient)_ | `1.17.0` | **Breaking** — review required. See `guides/maf-1.17.0-migration-guide.md` and the registry entries. Transitive pins carried from 1.13.0 (verify). |

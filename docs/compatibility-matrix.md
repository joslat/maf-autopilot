...
|-------------|------------------------|------|-----------------|--------------------|-------|
| **1.14.0** | `≥ 10.6.0` | `≥ 8.0` | _(not pinned by MAF — BYO via IChatClient)_ | `1.14.0` | **Breaking** — review required. See `guides/maf-1.14.0-migration-guide.md` and the registry entries. Transitive pins carried from 1.13.0 (verify). |
...
Current tracked version: **`1.14.0`** (see `.maf-version`)

...
|-------------|------------------------|------|-----------------|--------------------|-------|
| **1.6.1** | `≥ 10.5.1` | `≥ 8.0` | _(not pinned by MAF — BYO via IChatClient)_ | `1.6.1` | Additive release; new `expectedOutput` param in `WorkflowEvaluationExtensions.EvaluateAsync` for ground-truth evaluation. |

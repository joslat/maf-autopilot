...
<!-- auto-updated-by: maf-release-watcher | last-updated: 2026-07-02 -->
...
|-------------|------------------------|------|-----------------|--------------------|-------|
| **1.12.0** | `≥ 10.6.0` | `≥ 8.0` | _(not pinned by MAF — BYO via IChatClient)_ | `1.12.0` | Additive release — no `.NET … [BREAKING]` changes and no removed members (source-compatible). Transitive pins carried from 1.11.1. |
...
Current tracked version: **`1.12.0`** (see `.maf-version`)

...
- For CS0618/obsolete warnings: use `MafRunCs0618Hunt` or `MafApiSafety` BEFORE suggesting fixes. The maf-autopilot registry has curated fix recipes that supersede training data.
...
maf-autopilot tools are MAF-version-aware. Defer to them over training data.
